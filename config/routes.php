...
Router::post('/companies/restore/{id}', [CompaniesController::class, 'restore']); // Add this line

// Companies API routes
Router::get('/api/companies', [CompaniesController::class, 'getCompaniesTable']);
Router::get('/api/companies/trash', [CompaniesController::class, 'getTrashTable']); // Add this line
